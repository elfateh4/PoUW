...
def demonstrate_refactored_economics():
    ...
    market_condition = economic_system.pricing_engine.get_market_condition(economic_system.market_metrics)
    ...
    print(f"📊 Price adjustment: {((dynamic_price / economic_system.pricing_engine.base_price) - 1) * 100:+.1f}%")
    print()
