...
class PoUWOpReturnData:
    ...
    def to_bytes(self) -> bytes:
        ...
        data = struct.pack(">B", self.version)  # version (1 byte, big-endian)
        data += struct.pack(">B", self.op_code.value)  # op_code (1 byte, big-endian)
        data += struct.pack(">I", self.timestamp)  # timestamp (4 bytes, big-endian)
...
class StandardizedTransactionFormat:
    ...
    def create_task_submission_transaction(
        self,
    ...
    def create_worker_registration_transaction(
        self,
    ...
    def create_task_result_transaction(
        self,
    ...
    def create_gradient_share_transaction(
        self,
    ...
    def create_verification_proof_transaction(
        self,
...
def create_standardized_pouw_transaction(
    ...
    if transaction_type == "task_submission":
        return formatter.create_task_submission_transaction(
            data, node_id, task_id or "", inputs, outputs
        )
        ...
        return formatter.create_task_result_transaction(
            data, node_id, task_id or "", inputs, outputs
        )
    elif transaction_type == "gradient_share":
        return formatter.create_gradient_share_transaction(
            data, node_id, task_id or "", inputs, outputs
        )
    elif transaction_type == "verification_proof":
        return formatter.create_verification_proof_transaction(
            data, node_id, task_id or "", inputs, outputs
        )
    else:
