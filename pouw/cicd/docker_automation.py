...
class DockerImageBuilder:
    ...
    def build_image(
        self, config: ImageConfiguration, registry: Optional[ContainerRegistry] = None
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            for image in dangling_images:
                try:
                    ...
                    logger.warning(
                        f"Failed to remove dangling image {image_id[:12] if image_id else 'unknown'}: {e}"
                    )
    ...
    def get_pouw_build_configuration(self) -> BuildConfiguration:
        ...
        images = [
            ImageConfiguration(
                ...
                context=".",
                build_args={"PYTHON_VERSION": "3.12", "POUW_VERSION": "1.0.0"},
                labels={"app": "pouw", "component": "blockchain", "version": "1.0.0"},
            ),
            ImageConfiguration(
                name="pouw/blockchain",
                tag="production",
            ...
            ImageConfiguration(
                ...
                labels={"app": "pouw", "component": "ml-trainer", "version": "1.0.0"},
            ),
            ImageConfiguration(
                name="pouw/vpn-mesh",
                tag="latest",
                ...
                context=".",
                build_args={"PYTHON_VERSION": "3.12", "POUW_VERSION": "1.0.0"},
                labels={"app": "pouw", "component": "vpn-mesh", "version": "1.0.0"},
            ),
        ]

        return BuildConfiguration(
            images=images, parallel_builds=2, push_after_build=False, cleanup_after_build=True
        )
    ...
    def get_build_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "successful_builds": len(
                [b for b in self.builder.build_history if b.get("status") == "success"]
            ),
            "failed_builds": len(
                [b for b in self.builder.build_history if b.get("status") == "failed"]
            ),
