...
class TestAutomationManager:
    ...
    async def run_test_suite(self, config: TestConfiguration) -> TestSuiteResult:
        ...
        print(f"Results: {suite_result.passed} passed, {suite_result.failed} failed, "
...
async def main():
    ...
    print(f"Integration tests completed: {integration_result.passed}/{integration_result.total_tests} passed")
