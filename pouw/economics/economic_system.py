...
class EconomicSystem:
    ...
    def _generate_health_recommendations(self, health_indicators: Dict[str, float]) -> List[str]:
        ...
        if health_indicators['participant_activity'] < 50:
            recommendations.append("Low participant activity - consider marketing or incentive improvements")
        ...
        if health_indicators['reward_distribution'] < 50:
            recommendations.append("Limited reward distribution activity - monitor task submission rates")
