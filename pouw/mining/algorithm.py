...
class PoUWMiner:
    ...
    def mine_block(self, trainer: DistributedTrainer, iteration_message: IterationMessage,
                   batch_size: int, model_size: int, transactions: List[Transaction],
                   blockchain) -> Optional[Tuple[Block, MiningProof]]:
        """
    ...
    def _create_block_with_nonce(self, nonce: int, iteration_message: IterationMessage,
                                transactions: List[Transaction], blockchain) -> Block:
    ...
    def _store_mining_data(self, block: Block, trainer: DistributedTrainer, 
    ...
    def commit_zero_nonce_block(self, iteration: int, transactions: List[Transaction],
                               blockchain) -> str:
        """
...
class PoUWVerifier:
    ...
    def verify_block(self, block: Block, mining_proof: MiningProof,
                    trainer: DistributedTrainer) -> bool:
        """
    ...
    def _verify_ml_iteration(self, block: Block, mining_proof: MiningProof,
                           trainer: DistributedTrainer) -> bool:
