...
class MessageHistory:
    ...
    def __init__(self, max_history: int = 10000):
        ...
        self.message_slots: Dict[str, Dict[int, IterationMessage]] = (
            {}
        )  # task_id -> iteration -> message
    ...
    def get_message_range(
        self, task_id: str, start_iteration: int, end_iteration: int
    ) -> List[IterationMessage]:
    ...
    def get_merkle_tree_hash(self, task_id: str, start_iteration: int, end_iteration: int) -> str:
