...
class TestSimpleMLP:
    ...
    def test_model_creation(self):
        """Test model creation"""
        model = SimpleMLP(input_size=784, hidden_sizes=[128, 64], output_size=10)
...
class TestMiniBatch:
    ...
    def test_minibatch_creation(self):
        ...
        batch = MiniBatch(batch_id="batch_001", data=data, labels=labels, epoch=1)
...
class TestGradientUpdate:
    ...
    def test_message_map_conversion(self):
        ...
        update = GradientUpdate("miner_001", "task_001", 5, 1, [0, 10, 25], [0.1, -0.05, 0.2])
...
class TestDistributedTrainer:
    ...
    def test_peer_updates(self):
        ...
        # Add peer update
        update = GradientUpdate("miner_002", "task_001", 0, 0, [0, 10], [0.1, -0.05])
