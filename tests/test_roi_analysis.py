...
class TestROIAnalyzer(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.performance_metrics = {"performance_score": 0.85, "uptime": 0.98, "accuracy": 0.92}
    ...
    def test_miner_roi_calculation(self):
        ...
        roi_metrics = self.analyzer.calculate_participant_roi(
            ParticipantRole.MINER, self.performance_metrics, self.market_conditions
        )
        ...
        self.assertGreater(
            roi_metrics.daily_profit, roi_metrics.hourly_profit * 20
        )  # Should be ~24x

    def test_supervisor_roi_calculation(self):
        """Test supervisor ROI calculation"""
        roi_metrics = self.analyzer.calculate_participant_roi(
            ParticipantRole.SUPERVISOR, self.performance_metrics, self.market_conditions
        )
    ...
    def test_client_cost_savings(self):
        ...
        task_requirements = {"estimated_hours": 2.0, "gpu_count": 4, "complexity_multiplier": 1.5}
    ...
    def test_market_condition_adjustments(self):
        ...
        adjusted_costs = self.analyzer._adjust_costs_for_market(
            base_costs, high_electricity_conditions
        )
...
class TestConvenienceFunctions(unittest.TestCase):
    ...
    def test_analyze_miner_profitability(self):
        ...
        hardware_specs = {"gpu_count": 8, "gpu_memory": "24GB", "power_consumption": 2000}  # watts
...
class TestRiskAssessment(unittest.TestCase):
    ...
    def test_investment_recommendations(self):
        ...
        recommendation = self.analyzer._generate_recommendation(
            excellent_roi, ParticipantRole.MINER
        )
